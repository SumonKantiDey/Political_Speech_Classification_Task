...
def get_parser():
    ...
    parser.add_argument("--model_specification", default="Roberta Large Uncased", required=False, help="model name")
    parser.add_argument("--model_layer", default='last_two',type=str, help='Model layer')
    parser.add_argument("--pretrained_model_name", default="roberta-large", required=False, help="Pretrained model name")
